...
def main(args):
    ...
    backbone = args.backbone  # vgg resnet50
    ...
    if True:
        ...
        train_dataset = UnetDataset(train_lines, input_shape, num_classes, True, SUIMdevkit_path)
        val_dataset = UnetDataset(val_lines, input_shape, num_classes, False, SUIMdevkit_path)
...
def parse_args():
    ...
    parser.add_argument("--backbone", default="vgg", type=str, help="vgg, resnet50")
    parser.add_argument("--input-size", default=512, type=int, help="the size of input image")
    parser.add_argument("--model-path", default="./logs/ep380-loss0.268-val_loss0.407.pth", help="model weights path")
    ...
    parser.add_argument("-bf", "--batch-size-freeze", default=16, type=int)
    parser.add_argument("-buf", "--batch-size-unfreeze", default=16, type=int)
    parser.add_argument(
        "--epochs-freeze",
        default=0,
        type=int,
    ...
    parser.add_argument(
        "--init-epoch", default=380, type=int, metavar="N", help="init epoch"
    )
